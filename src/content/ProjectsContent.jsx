...
const ProjectsContent = () => (
  <div className="overflow-auto" style={{ maxHeight: 'calc(100vh - 12rem)', maxWidth: '70vh' }}>
    <h1 className="text-4xl font-bold text-accent mb-4 font-lora">Projects Content</h1>
    <h2 className="text-2xl font-semibold text-accent mb-2 font-lora">Welcome to the Projects section.</h2>
    ...
    <img src={cardsFlames} alt="Cards Flames Animation" className="w-full mt-4 mb-4" />
    ...
    <img src={dreamy} alt="Dreamy Animation" className="w-full mt-4 mb-4" />
    ...
    <img src={keytrip} alt="Keytrip Animation" className="w-full mt-4 mb-4" />
